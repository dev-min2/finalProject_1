        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <br />
                    <div class="d-flex">
                        <input class="form-control text-center me-3" id="inputQuantity" type="number" min="1" max="99"
                            value="1" style="max-width: 6rem" v-if="productDetail.product_stock > 0"
                        ...
                        &nbsp;
                        <h4 v-if="productDetail.product_stock > 0" style="color : gray; margin-inline-start: auto">총 상품
                ...
                <table class="table" style=text-align:center>
                    ...
                    <tbody>
                        ...
                        <tr v-else v-for="(review, idx) in reviewList" :key="idx">
                            ...
                            <td><input type="button" class="button" @click="addReviewLikeCnt(review.review_no)"> {{ review.review_like_cnt }} </td>
            ...
            <div id="order">
                <div id="arrow"></div>
                <h2 id="text1" onclick="openDiv()" style="font: bolder; font-size: 30px; text-align: left">취소/교환/반품안내
                </h2>
                <ul>
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            await this.showReviewList(this.$route.query.pno);
        ...
        methods: {
            ...
            async showReviewList(pno){
                this.$showLoading();
                const result = await axios.get(`/api/product/productdetails/review/${pno}`).catch((err)=> console.log(err));
            ...
            async addReviewLikeCnt(rno){
                this.$showLoading();
                const result = await axios.put(`/api/product/productdetails/review/${rno}/${this.product_no}`).catch((err)=> console.log(err));
                this.reviewList= result.data;
                for(let i = 0; i < this.reviewList.length; ++i) {
                    const div = document.createElement('div');
                    div.innerHTML = this.reviewList[i].content;
