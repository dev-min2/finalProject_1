                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <router-link class="nav-link" to="/adminMain">
                            ...
                            <router-link class="nav-link" to="/adminMemberList">회원 조회</router-link>
                            <li class="nav-item"><router-link class="nav-link" to="/AdminCoupon">쿠폰 관리</router-link></li>
